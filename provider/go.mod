module github.com/FreeWaveTechnologies/pulumi-clickhouse/provider
...
require (
	...
	terraform-provider-clickhouse v0.0.5
)
...
replace terraform-provider-clickhouse => github.com/ClickHouse/terraform-provider-clickhouse v0.0.5
