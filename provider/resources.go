...
import (
	...
	"github.com/FreeWaveTechnologies/pulumi-clickhouse/provider/pkg/version"
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		P:    shimv2.NewProvider(clickhouse.New(version.Version)()),
		Name: "clickhouse",
		...
		Keywords:   []string{"pulumi", "clickhouse", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/FreeWaveTechnologies/pulumi-clickhouse",
	...
	prov.MustComputeTokens(tokens.SingleModule("clickhouse_", mainMod,
