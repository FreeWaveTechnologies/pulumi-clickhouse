...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `clickhouse` with the `NAME` of your provider.
...
- binary: pulumi-resource-clickhouse
  ...
  ignore: []
  ldflags:
  - -X github.com/FreeWaveTechnologies/pulumi-clickhouse/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-clickhouse_darwin_amd64_v1
│   └── pulumi-resource-clickhouse
├── pulumi-clickhouse_darwin_arm64
│   └── pulumi-resource-clickhouse
├── pulumi-clickhouse_linux_amd64_v1
│   └── pulumi-resource-clickhouse
├── pulumi-clickhouse_linux_arm64
│   └── pulumi-resource-clickhouse
├── pulumi-clickhouse_windows_amd64_v1
│   └── pulumi-resource-clickhouse.exe
└── pulumi-clickhouse_windows_arm64
    └── pulumi-resource-clickhouse.exe
```
